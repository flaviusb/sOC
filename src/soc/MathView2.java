...
import net.sourceforge.jeuclid.swt.*;
 ...
 * @version $Revision$
 */
public final class MathView2 extends Canvas {
     ...
     */
    public MathView2(final Composite parent, final int style) {
        super(parent, style);
        this.setDocument(new DocumentElement());
        this.addDisposeListener(new DisposeListener() {
            public void widgetDisposed(final DisposeEvent e) {
                MathView2.this.widgetDisposed(e);
            }
        });
        this.addPaintListener(new PaintListener() {
            public void paintControl(final PaintEvent e) {
                MathView2.this.paintControl(e);
            }
        });
        layoutContext.setParameter(Parameter.MATHSIZE, 33.0f);
    }
